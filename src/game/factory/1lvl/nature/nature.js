...
import groundLedgeInsidePng from './assets/groundLedgeInside.png';
  ...
  statics: {
    ...
    ground: {
      ...
      ledge: {
        ...
        middle: (left, top, width) => ({
          left, top, width, height: 74, asset: getAsset(groundLedgeInsidePng)
        }),

        //getItem(left, top, statics.groundLedge.middle),
